...
1. Add a failing first-layer KSR assertion at the `slice_project` seam that rejects the distant X169 collection and proves selection of the source collection near X137, plus a focused gap-loop reversibility assertion.
