...
3. Add success and every error path to a constrained thread-stack test with a 10k-node nested predecessor; use the shared project-slice test baseline of 64 KiB on Unix and 256 KiB on Windows, and require iterative cleanup.
