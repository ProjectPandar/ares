...
4. Add direct role/branch/alignment/no-orientation tests and 64 KiB constrained-stack transformation and sink coverage. Do not invent a fallible internal API.
