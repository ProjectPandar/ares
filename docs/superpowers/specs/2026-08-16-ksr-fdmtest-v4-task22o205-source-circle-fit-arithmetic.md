...
A focused high-coordinate counterexample pins the source center `(151.545998, 102.773998)` where the rearranged formula produces `(151.545999, 102.773998)`. The fixture retains its `I-3.392` versus `I-3.393` divergence after this arithmetic fix, proving that its stored arc differs earlier in fitting range/candidate selection rather than in the reached three-point expression. No debug instrumentation remains. Files stay below 400 LOC; focused arc tests, formatting, and Clippy remain clean.
