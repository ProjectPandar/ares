...
6. Add iterative O16 sinks in a new `project_slice/incomplete_sink/layer_region.rs` child module so the existing 392-line parent remains below 400 LOC. Success and the public incomplete lifecycle must fit a 64 KiB stack when both retained predecessor tree families are deepened to 10,000 nodes.
...
6. Success and public-incomplete cleanup pass on 64 KiB stacks after deepening both 10,000-node predecessor families. The public lifecycle invokes O16 once and remains incomplete.
