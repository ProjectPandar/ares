...
pub(crate) use clipper::{
    ...
    offset_expolygons_paths, offset_open_paths, offset_paths, offset_paths_tree, offset2_ex,
    opening_ex, union_ex, union_expolygons, variable_offset_inner_ex, xor_ex,
};
