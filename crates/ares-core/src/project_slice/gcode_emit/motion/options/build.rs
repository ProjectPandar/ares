...
impl MotionOptions {
    pub(in crate::project_slice::gcode_emit) fn from_traversal(
        ...
        Self {
            ...
            z_travel_feedrate: gcode.travel_speed_z.0 * 60.0,
            ...
            extrusion_role_markers: full.process.gcode.max_volumetric_extrusion_rate_slope.0 > 0.0,
