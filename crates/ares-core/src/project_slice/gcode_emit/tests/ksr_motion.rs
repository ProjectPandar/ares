...
#[tokio::test]
async fn ksr_first_concentric_path_keeps_source_orientation() {
    let output = crate::slice_project(
        crate::project_slice::tests::support::ksr_project(),
        crate::project_slice::tests::support::metadata(),
    )
    ...
    assert_eq!(lines[first_infill - 1], "G1 X137.276 Y101.382 F60000");
    assert_eq!(lines[first_infill + 3], "G1 X139.964 Y98.694 E.11678");
    assert_eq!(lines[first_infill + 11], "G1 X137.276 Y101.342 E.03682");
}
