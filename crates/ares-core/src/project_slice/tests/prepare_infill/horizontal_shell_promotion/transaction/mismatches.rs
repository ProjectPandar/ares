...
#[test]
fn task22o25_every_outer_alignment_mismatch_rejects_before_schedule_visits() {
...
#[test]
fn task22o25_every_record_count_mismatch_rejects_before_schedule_visits() {
    let mut objects = prepared();
...
#[test]
fn task22o25_every_slot_presence_mismatch_rejects_before_schedule_visits() {
    let mut objects = prepared();
...
#[test]
fn task22o25_every_input_and_plan_identity_mismatch_rejects_before_schedule_visits() {
    for mutate in [
