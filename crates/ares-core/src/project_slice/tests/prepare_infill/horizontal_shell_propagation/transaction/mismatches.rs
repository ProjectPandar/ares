...
#[test]
fn task22o26_every_outer_alignment_mismatch_rejects_before_clones() {
...
#[test]
fn task22o26_every_record_count_mismatch_rejects_before_clones() {
    let mut objects = prepared();
...
#[test]
fn task22o26_every_slot_presence_mismatch_rejects_before_clones() {
    let mut objects = prepared();
...
#[test]
fn task22o26_every_input_and_plan_identity_mismatch_rejects_before_clones() {
    for mutate in [
