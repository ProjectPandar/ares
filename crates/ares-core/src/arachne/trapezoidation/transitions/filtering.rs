...
use super::{NearbyTransitionSearch, SkeletalTrapezoidation, TransitionMidRef, point_distance};

impl SkeletalTrapezoidation<'_> {
    pub(super) fn filter_transition_mids(&mut self) {
    ...
    pub(super) fn dissolve_nearby_transitions(
        &self,
    ...
    pub(super) fn dissolve_bead_count_region(
        &mut self,
        edge_to_start: EdgeId,
    ...
    pub(super) fn filter_end_of_central_transition(
        &mut self,
        edge_to_start: EdgeId,
        traveled_distance: i64,
