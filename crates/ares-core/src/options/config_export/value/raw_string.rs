...
use super::ConfigValueError;

pub(super) struct RawStringSerializer;
...
fn not_string() -> ConfigValueError {
    ConfigValueError("ConfigOptionStrings elements must be strings".to_owned())
}
