...
#[cfg(feature = "task22j-browser-oracle")]
#[wasm_bindgen(js_name = task22jBrowserInputOracle)]
pub fn task22j_browser_input_oracle(input: Vec<u8>) -> Result<Vec<u8>, JsValue> {
    ares_core::task22j_browser_input_oracle(input).map_err(slice_error_js)
}

#[cfg(feature = "task22j-browser-oracle")]
#[wasm_bindgen(js_name = task22jBrowserOracle)]
pub fn task22j_browser_oracle(input: Vec<u8>) -> Result<Vec<u8>, JsValue> {
    ares_core::task22j_browser_oracle(input).map_err(slice_error_js)
}
