...
899 of 1001 printers pass the strict ordered-byte comparison (generator identity/timestamp lines normalized; classic wall generator baseline; cube model).
...
| DIVERGENT | Blocks/BLOCKS RF50 0.4 nozzle | (no match across 6 oracle runs) first difference at byte 8211 (line 328, column 7; expected 120479 bytes, actual 121907 bytes) context:   line 327: ";WIDTH:0.45"   line 328: expected "G1 F3169"; actual "G1 F3173"   line 329: "G1 X246.052 Y253.948 E.2539" |
...
| ORCA_ERROR | Cubicon/Cubicon xCeler-I 0.4 nozzle | Export/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-gimNCk/command-rcXCcU") |
| ORCA_ERROR | Cubicon/Cubicon xCeler-Mini 0.4 nozzle | Export/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-gimNCk/command-tb470D") |
| ORCA_ERROR | Cubicon/Cubicon xCeler-Plus 0.4 nozzle | Export/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-gimNCk/command-6ggqYB") |
...
| ORCA_ERROR | Custom/MyToolChanger 0.8 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-gimNCk/command-zUEHEO") |
...
| PASS | Eryone/Eryone ER20 0.8 nozzle |  |
...
| ORCA_ERROR | Flashforge/Flashforge Creator 5 0.4 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-gimNCk/command-vmWUAT") |
...
| ORCA_ERROR | Flashforge/Flashforge Creator 5 Pro 0.6 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-gimNCk/command-e8cqUZ") |
| ORCA_ERROR | Flashforge/Flashforge Creator 5 Pro 0.8 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-gimNCk/command-98nmdM") |
...
| DIVERGENT | Kingroon/Kingroon KP3S V1 0.4 nozzle | (no match across 6 oracle runs) first difference at byte 5236 (line 216, column 7; expected 107514 bytes, actual 107938 bytes) context:   line 215: ";WIDTH:0.45"   line 216: expected "G1 F4056"; actual "G1 F4075"   line 217: "G1 X94.398 Y85.602 E.29177" |
...
| DIVERGENT | LONGER/LONGER LK10 Plus (0.8 nozzle) | (no match across 6 oracle runs) first difference at byte 4041 (line 159, column 7; expected 102733 bytes, actual 103059 bytes) context:   line 158: ";WIDTH:0.82"   line 159: expected "G1 F2786"; actual "G1 F2797"   line 160: "G1 X153.611 Y155 E.4294" |
...
| DIVERGENT | Prusa/Prusa CORE One L 0.4 nozzle | (no match across 6 oracle runs) first difference at byte 4811 (line 230, column 8; expected 95376 bytes, actual 96077 bytes) context:   line 229: ";WIDTH:0.45"   line 230: expected "G1 F1890"; actual "G1 F1893"   line 231: "G1 X145.675 Y154.325 E.29279" |
...
| ORCA_ERROR | Prusa/Prusa XL 5T 0.3 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-gimNCk/command-wlAhDq") |
| ORCA_ERROR | Prusa/Prusa XL 5T 0.4 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-gimNCk/command-e4n9hv") |
| ORCA_ERROR | Prusa/Prusa XL 5T 0.5 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-gimNCk/command-pjf7qM") |
| ORCA_ERROR | Prusa/Prusa XL 5T 0.6 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-gimNCk/command-UKWBhM") |
...
| DIVERGENT | Ratrig/RatRig V-Core 4 IDEX 400 0.8 nozzle | (no match across 6 oracle runs) first difference at byte 19074 (line 767, column 1; expected 84493 bytes, actual 84753 bytes) context:   line 766: "G1 X203.925 Y196.075 E.56816"   line 767: expected "M73 P29 R2"; actual "G1 X203.925 Y203.845 E.56237"   line 768: expected "G1 X203.925 Y203.845 E.56237"; actual "M73 P29 R1" |
...
| PASS | Snapmaker/Snapmaker Artisan (0.2 nozzle) |  |
...
| ORCA_ERROR | Snapmaker/Snapmaker U1 (0.2 nozzle) | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-gimNCk/command-rtgRu9") |
| ORCA_ERROR | Snapmaker/Snapmaker U1 (0.4 nozzle) | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-gimNCk/command-1rBXj7") |
| ORCA_ERROR | Snapmaker/Snapmaker U1 (0.4+0.6 nozzle) | Export/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-gimNCk/command-c0isBz") |
| PASS | Snapmaker/Snapmaker U1 (0.6 nozzle) |  |
| ORCA_ERROR | Snapmaker/Snapmaker U1 (0.8 nozzle) | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-gimNCk/command-xalpfL") |
...
| ORCA_ERROR | WonderMaker/WonderMaker ZR Ultra 0.4 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-gimNCk/command-Y2tHhr") |
| ORCA_ERROR | WonderMaker/WonderMaker ZR Ultra 0.6 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-gimNCk/command-K2kb69") |
| ORCA_ERROR | WonderMaker/WonderMaker ZR Ultra 0.8 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-gimNCk/command-I3OixW") |
| ORCA_ERROR | WonderMaker/WonderMaker ZR Ultra S 0.2 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-gimNCk/command-KRxEZ1") |
| ORCA_ERROR | WonderMaker/WonderMaker ZR Ultra S 0.4 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-gimNCk/command-pXXhcM") |
...
| DIVERGENT | iQ/iQ TiQ8 0.4 Nozzle | (no match across 6 oracle runs) first difference at byte 22135 (line 885, column 6; expected 129647 bytes, actual 130358 bytes) context:   line 884: "G1 Z1 F18000"   line 885: expected "G1 X246.061 Y187.924 Z1"; actual "G1 X237.93 Y195.977 Z1"   line 886: "G1 Z.6" |
