...
876 of 1001 printers pass the strict ordered-byte comparison (generator identity/timestamp lines normalized; classic wall generator baseline; cube model).
...
| DIVERGENT | Artillery/Artillery Sidewinder X4 Pro 0.4 nozzle | (no match across 6 oracle runs) first difference at byte 1866 (line 99, column 1; expected 90379 bytes, actual 90773 bytes) context:   line 98: "G1 Z.2"   line 99: expected "M73 P6 R6"; actual "G1 E1.3 F2400"   line 100: expected "G1 E1.3 F2400"; actual "M73 P6 R6" |
...
| DIVERGENT | Creality/Creality CR-6 Max 0.2 nozzle | (no match across 6 oracle runs) first difference at byte 4888 (line 210, column 10; expected 393302 bytes, actual 394066 bytes) context:   line 209: "G1 X204.021 Y204.395 E.00214"   line 210: expected "M73 P5 R23"; actual "M73 P5 R22"   line 211: "G1 X195.605 Y195.979 E.10247" |
...
| DIVERGENT | Creality/Creality K2 Plus 0.8 nozzle | (no match across 6 oracle runs) first difference at byte 1052 (line 46, column 1; expected 78834 bytes, actual 79002 bytes) context:   line 45: "G1 X0 Y150 F6000"   line 46: expected "M73 P13 R2"; actual "G1 X0 Y0 E15 F6000"   line 47: expected "G1 X0 Y0 E15 F6000"; actual "G1 X150 Y0 E15 F6000" |
...
| DIVERGENT | Creality/Creality SPARKX i7 0.8 nozzle | (no match across 6 oracle runs) first difference at byte 954 (line 46, column 7; expected 88196 bytes, actual 88503 bytes) context:   line 45: "G1 X115 E.3742  F1600"   line 46: expected "M73 P15 R3"; actual "M73 P14 R3"   line 47: "G1 X110 E.3742  F6400" |
...
| ORCA_ERROR | Cubicon/Cubicon xCeler-I 0.4 nozzle | Export/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-wFDj0V/command-vWAMsj") |
| ORCA_ERROR | Cubicon/Cubicon xCeler-Mini 0.4 nozzle | Export/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-wFDj0V/command-nY27wf") |
| ORCA_ERROR | Cubicon/Cubicon xCeler-Plus 0.4 nozzle | Export/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-wFDj0V/command-KCeBkQ") |
...
| DIVERGENT | Elegoo/Elegoo Neptune 3 Plus 0.2 nozzle | (no match across 6 oracle runs) first difference at byte 5422 (line 243, column 7; expected 225250 bytes, actual 225674 bytes) context:   line 242: ";WIPE_END"   line 243: expected "G1 X164.555 Y166.596 Z.65"; actual "G1 X166.011 Y165.976 Z.65"   line 244: "G1 Z.25" |
...
| DIVERGENT | Flashforge/Flashforge Artemis 0.4 Nozzle | (no match across 6 oracle runs) first difference at byte 5282 (line 252, column 15; expected 110781 bytes, actual 112430 bytes) context:   line 251: "G1 X4.458 Y4.458 F6000"   line 252: expected "G1 X4.458 Y4.439"; actual "G1 X4.458 Y4.458"   line 253: expected "G1 X4.439 Y4.439"; actual "G1 X4.458 Y4.439" |
| ORCA_ERROR | Flashforge/Flashforge Creator 5 0.4 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-wFDj0V/command-H6kgRp") |
| ORCA_ERROR | Flashforge/Flashforge Creator 5 0.6 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-wFDj0V/command-5rSFXt") |
| ORCA_ERROR | Flashforge/Flashforge Creator 5 0.8 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-wFDj0V/command-bFKG0k") |
| ORCA_ERROR | Flashforge/Flashforge Creator 5 Pro 0.4 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-wFDj0V/command-qGbqIj") |
| ORCA_ERROR | Flashforge/Flashforge Creator 5 Pro 0.6 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-wFDj0V/command-jrfEpE") |
| ORCA_ERROR | Flashforge/Flashforge Creator 5 Pro 0.8 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-wFDj0V/command-H7hwdI") |
...
| DIVERGENT | LH/LH Stinger MMU 0.4 nozzle | (no match across 6 oracle runs) first difference at byte 627 (line 23, column 1; expected 134957 bytes, actual 135322 bytes) context:   line 22: ";TYPE:Custom"   line 23: expected "_SP_PRINT_START LANE=0 TEMP=230"; actual " _SP_PRINT_START LANE=0 TEMP=230"   line 24: "" |
...
| DIVERGENT | Prusa/Prusa CORE One L HF 0.4 nozzle | (no match across 6 oracle runs) first difference at byte 7439 (line 340, column 6; expected 95498 bytes, actual 95609 bytes) context:   line 339: ";WIDTH:0.45"   line 340: expected "G1 F1912"; actual "G1 F1899"   line 341: "G1 X145.675 Y154.325 E.29279" |
...
| DIVERGENT | Prusa/Prusa MINIIS 0.25 nozzle | (no match across 6 oracle runs) first difference at byte 17814 (line 800, column 1; expected 215124 bytes, actual 215474 bytes) context:   line 799: "G1 X94.131 Y88.993 E.00421"   line 800: expected "M73 P27 R13"; actual "G1 X91.007 Y85.869 E.05384"   line 801: expected "G1 X91.007 Y85.869 E.05384"; actual "G1 X90.661 Y85.869 E.00421" |
...
| DIVERGENT | Prusa/Prusa MK3.5 0.4 nozzle | (no match across 6 oracle runs) first difference at byte 4451 (line 208, column 8; expected 110726 bytes, actual 111095 bytes) context:   line 207: ";WIDTH:0.45"   line 208: expected "G1 F1476"; actual "G1 F1477"   line 209: "G1 X121.082 Y108.918 E.26523" |
...
| DIVERGENT | Prusa/Prusa MK3S 0.8 nozzle | (no match across 6 oracle runs) first difference at byte 6229 (line 297, column 7; expected 64460 bytes, actual 64861 bytes) context:   line 296: ";TYPE:Skirt"   line 297: expected "G1 F1401"; actual "G1 F1436"   line 298: "G1 X120 Y112.418 E.78794" |
...
| DIVERGENT | Prusa/Prusa XL 0.4 nozzle | (no match across 6 oracle runs) first difference at byte 3163 (line 134, column 1; expected 92808 bytes, actual 93155 bytes) context:   line 133: "G1 Z.2"   line 134: expected "M73 P83 R6"; actual "G1 E.8 F1800"   line 135: expected "G1 E.8 F1800"; actual ";TYPE:Bottom surface" |
...
| ORCA_ERROR | Prusa/Prusa XL 5T 0.4 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-wFDj0V/command-nMGF72") |
| ORCA_ERROR | Prusa/Prusa XL 5T 0.5 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-wFDj0V/command-qV8Oeg") |
| PASS | Prusa/Prusa XL 5T 0.6 nozzle |  |
| ORCA_ERROR | Prusa/Prusa XL 5T 0.8 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-wFDj0V/command-0bGalJ") |
...
| DIVERGENT | Ratrig/RatRig V-Core 4 HYBRID 500 0.8 nozzle | (no match across 6 oracle runs) first difference at byte 3050 (line 126, column 7; expected 82258 bytes, actual 83126 bytes) context:   line 125: ";WIDTH:0.75"   line 126: expected "G1 F2205"; actual "G1 F2222"   line 127: "G1 X246.771 Y253.229 E.46736" |
...
| DIVERGENT | RolohaunDesign/Rolohaun Delta Flyer Refit 0.4 nozzle | (no match across 6 oracle runs) first difference at byte 9819 (line 385, column 8; expected 125576 bytes, actual 126094 bytes) context:   line 384: ";WIDTH:0.44"   line 385: expected "G1 F3821"; actual "G1 F3827"   line 386: "G1 X-1.586 Y6.38 E.25775" |
...
| ORCA_ERROR | Snapmaker/Snapmaker U1 (0.4 nozzle) | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-wFDj0V/command-TfZGyA") |
| ORCA_ERROR | Snapmaker/Snapmaker U1 (0.4+0.6 nozzle) | Export/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-wFDj0V/command-WDL8Su") |
| ORCA_ERROR | Snapmaker/Snapmaker U1 (0.6 nozzle) | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-wFDj0V/command-MiLSni") |
| ORCA_ERROR | Snapmaker/Snapmaker U1 (0.8 nozzle) | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-wFDj0V/command-TJMZB2") |
...
| DIVERGENT | Sovol/Sovol SV06 Plus 0.4 nozzle | (no match across 6 oracle runs) first difference at byte 13324 (line 585, column 1; expected 105332 bytes, actual 105664 bytes) context:   line 584: "G1 X146.362 Y152.422 E.27734"   line 585: expected "M73 P18 R4"; actual "G1 X146.362 Y151.861 E.01817"   line 586: expected "G1 X146.362 Y151.861 E.01817"; actual "M73 P18 R4" |
...
| DIVERGENT | Volumic/EXO65 (0.6 nozzle) | (no match across 6 oracle runs) first difference at byte 745 (line 43, column 9; expected 113606 bytes, actual 115034 bytes) context:   line 42: "G1 E-2.4 F1800"   line 43: expected "M73 P2 R4"; actual "M73 P2 R5"   line 44: ";_SET_FAN_SPEED_CHANGING_LAYER" |
...
| DIVERGENT | Volumic/VS30MK3 Stage 2 (0.4 nozzle) | (no match across 6 oracle runs) first difference at byte 6247 (line 268, column 6; expected 101017 bytes, actual 101231 bytes) context:   line 267: ";WIDTH:0.48"   line 268: expected "G1 F3692"; actual "G1 F3774"   line 269: "G1 X146.157 Y103.843 E.27933" |
...
| ORCA_ERROR | WonderMaker/WonderMaker ZR Ultra 0.2 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-wFDj0V/command-dhDvFx") |
| PASS | WonderMaker/WonderMaker ZR Ultra 0.4 nozzle |  |
| ORCA_ERROR | WonderMaker/WonderMaker ZR Ultra 0.6 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-wFDj0V/command-RbwVHz") |
| PASS | WonderMaker/WonderMaker ZR Ultra 0.8 nozzle |  |
| ORCA_ERROR | WonderMaker/WonderMaker ZR Ultra S 0.2 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-wFDj0V/command-bvI4SS") |
| ORCA_ERROR | WonderMaker/WonderMaker ZR Ultra S 0.4 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-wFDj0V/command-3Hppws") |
