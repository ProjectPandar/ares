...
| DIVERGENT | BBL/Bambu Lab X1E 0.4 nozzle | (no match across 6 oracle runs) first difference at byte 57437 (line 976, column 1; expected 167440 bytes, actual 167652 bytes) context:   line 975: "    G0 F1200.0 X210 Y1.5  Z0.2 E0.357"   line 976: expected ""; actual "M73 P56 R5"   line 977: expected "    G0 X48.0 E11.9 F6033.27"; actual "" |
...
| DIVERGENT | BBL/Bambu Lab X1E 0.8 nozzle | (no match across 6 oracle runs) first difference at byte 122 (line 3, column 57; expected 109860 bytes, actual 110532 bytes) context:   line 2: "; generated by <SLICER> 2.4.2 on <TIMESTAMP>"   line 3: expected "; model printing time: 2m 7s; total estimated time: 9m 45s"; actual "; model printing time: 2m 7s; total estimated time: 9m 44s"   line 4: "; estimated first layer printing time (normal mode) = 7m 37s" |
...
| DIVERGENT | Blocks/BLOCKS RF50 0.4 nozzle | (no match across 6 oracle runs) first difference at byte 8211 (line 328, column 7; expected 120984 bytes, actual 121907 bytes) context:   line 327: ";WIDTH:0.45"   line 328: expected "G1 F3164"; actual "G1 F3173"   line 329: "G1 X246.052 Y253.948 E.2539" |
...
| ORCA_ERROR | Cubicon/Cubicon xCeler-I 0.4 nozzle | Export/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-twOzjy/command-JUzDmx") |
| ORCA_ERROR | Cubicon/Cubicon xCeler-Mini 0.4 nozzle | Export/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-twOzjy/command-yvyN8U") |
| ORCA_ERROR | Cubicon/Cubicon xCeler-Plus 0.4 nozzle | Export/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-twOzjy/command-zXcHhh") |
...
| ORCA_ERROR | Custom/MyToolChanger 0.2 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-twOzjy/command-4cNU7g") |
| ORCA_ERROR | Custom/MyToolChanger 0.4 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-twOzjy/command-XqoCmP") |
...
| ORCA_ERROR | Flashforge/Flashforge Creator 5 0.4 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-twOzjy/command-NfUHx9") |
| PASS | Flashforge/Flashforge Creator 5 0.6 nozzle |  |
| ORCA_ERROR | Flashforge/Flashforge Creator 5 0.8 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-twOzjy/command-XXCAAu") |
...
| DIVERGENT | LONGER/LONGER LK10 (0.8 nozzle) | (no match across 6 oracle runs) first difference at byte 16112 (line 659, column 1; expected 102701 bytes, actual 103095 bytes) context:   line 658: "G1 X110.137 Y110.137 E.44845"   line 659: expected "M73 P16 R2"; actual "G1 X113.366 Y110.137 E.21665"   line 660: expected "G1 X113.366 Y110.137 E.21665"; actual "M73 P16 R2" |
| PASS | LONGER/LONGER LK10 Plus (0.2 nozzle) |  |
| PASS | LONGER/LONGER LK10 Plus (0.4 nozzle) |  |
| PASS | LONGER/LONGER LK10 Plus (0.6 nozzle) |  |
| DIVERGENT | LONGER/LONGER LK10 Plus (0.8 nozzle) | (no match across 6 oracle runs) first difference at byte 6829 (line 272, column 7; expected 102339 bytes, actual 103059 bytes) context:   line 271: ";WIDTH:0.85"   line 272: expected "G1 F1957"; actual "G1 F1970"   line 273: "G1 X157.032 Y162.968 E.39835" |
...
| DIVERGENT | Prusa/Prusa CORE One L 0.8 nozzle | (no match across 6 oracle runs) first difference at byte 2106 (line 106, column 7; expected 51646 bytes, actual 51842 bytes) context:   line 105: "G1 E2 F2400 ; deretraction after the initial one"   line 106: expected "M73 P93 R1"; actual "M73 P92 R2"   line 107: "G0 E5 X235 Z0.2 F500 ; purge" |
| DIVERGENT | Prusa/Prusa CORE One L HF 0.4 nozzle | (no match across 6 oracle runs) first difference at byte 7439 (line 340, column 6; expected 95104 bytes, actual 95609 bytes) context:   line 339: ";WIDTH:0.45"   line 340: expected "G1 F1912"; actual "G1 F1899"   line 341: "G1 X145.675 Y154.325 E.29279" |
...
| DIVERGENT | Prusa/Prusa MK3S 0.8 nozzle | (no match across 6 oracle runs) first difference at byte 1810 (line 83, column 1; expected 63180 bytes, actual 64861 bytes) context:   line 82: "G1 X120 Y112.418 E1.02139"   line 83: expected "M73 P3 R4"; actual "G1 X118.681 Y112.026 E.14058"   line 84: expected "G1 X118.681 Y112.026 E.14058"; actual "M73 P3 R4" |
...
| DIVERGENT | Prusa/Prusa XL 0.8 nozzle | (no match across 6 oracle runs) first difference at byte 4422 (line 198, column 22; expected 53460 bytes, actual 53824 bytes) context:   line 197: ";WIPE_END"   line 198: expected "G1 X181.559 Y183.324 F24000"; actual "G1 X181.559 Y183.324 Z1 F24000"   line 199: expected "G1 E.6 F1800"; actual "G1 Z.6" |
| PASS | Prusa/Prusa XL 5T 0.25 nozzle |  |
| ORCA_ERROR | Prusa/Prusa XL 5T 0.3 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-twOzjy/command-fEnI3n") |
| ORCA_ERROR | Prusa/Prusa XL 5T 0.4 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-twOzjy/command-NnJ5sV") |
| PASS | Prusa/Prusa XL 5T 0.5 nozzle |  |
| PASS | Prusa/Prusa XL 5T 0.6 nozzle |  |
| ORCA_ERROR | Prusa/Prusa XL 5T 0.8 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-twOzjy/command-xFGZ6s") |
...
| DIVERGENT | Ratrig/RatRig V-Core 4 IDEX 400 0.8 nozzle | (no match across 6 oracle runs) first difference at byte 3125 (line 127, column 7; expected 84184 bytes, actual 84753 bytes) context:   line 126: ";WIDTH:0.75"   line 127: expected "G1 F2209"; actual "G1 F2226"   line 128: "G1 X196.771 Y203.229 E.46736" |
...
| DIVERGENT | RolohaunDesign/Rolohaun Delta Flyer Refit 0.4 nozzle | (no match across 6 oracle runs) first difference at byte 6910 (line 261, column 7; expected 125645 bytes, actual 126094 bytes) context:   line 260: ";WIDTH:0.44"   line 261: expected "G1 F3787"; actual "G1 F3790"   line 262: "G1 X-1.586 Y6.38 E.25775" |
...
| ORCA_ERROR | Snapmaker/Snapmaker U1 (0.2 nozzle) | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-twOzjy/command-GrYhW0") |
| ORCA_ERROR | Snapmaker/Snapmaker U1 (0.4 nozzle) | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-twOzjy/command-V4uyj5") |
| ORCA_ERROR | Snapmaker/Snapmaker U1 (0.4+0.6 nozzle) | Export/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-twOzjy/command-WtB366") |
| ORCA_ERROR | Snapmaker/Snapmaker U1 (0.6 nozzle) | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-twOzjy/command-eStuzn") |
| ORCA_ERROR | Snapmaker/Snapmaker U1 (0.8 nozzle) | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-twOzjy/command-sldLPD") |
...
| DIVERGENT | Volumic/EXO65 (0.6 nozzle) | (no match across 6 oracle runs) first difference at byte 745 (line 43, column 9; expected 114002 bytes, actual 115034 bytes) context:   line 42: "G1 E-2.4 F1800"   line 43: expected "M73 P2 R4"; actual "M73 P2 R5"   line 44: ";_SET_FAN_SPEED_CHANGING_LAYER" |
...
| DIVERGENT | Volumic/VS30MK3 Stage 2 (0.4 nozzle) | (no match across 6 oracle runs) first difference at byte 3754 (line 163, column 7; expected 100710 bytes, actual 101231 bytes) context:   line 162: ";WIDTH:0.48"   line 163: expected "G1 F3663"; actual "G1 F3674"   line 164: "G1 X146.157 Y103.843 E.27933" |
...
| DIVERGENT | WEMAKE3D/WEMAKE3D PhoenixProV1 0.6mm nozzle | (no match across 6 oracle runs) first difference at byte 1584 (line 79, column 1; expected 108501 bytes, actual 109754 bytes) context:   line 78: "G1 X156.477 Y142.424 E.10062"   line 79: expected "M73 P44 R6"; actual "G1 X157.562 Y143.499 E.10062"   line 80: expected "G1 X157.562 Y143.499 E.10062"; actual "G1 X157.97 Y145 E.10237" |
...
| ORCA_ERROR | WonderMaker/WonderMaker ZR Ultra 0.2 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-twOzjy/command-YEKdt8") |
| ORCA_ERROR | WonderMaker/WonderMaker ZR Ultra 0.4 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-twOzjy/command-6tjNi6") |
| ORCA_ERROR | WonderMaker/WonderMaker ZR Ultra 0.6 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-twOzjy/command-mzQH52") |
| PASS | WonderMaker/WonderMaker ZR Ultra 0.8 nozzle |  |
| PASS | WonderMaker/WonderMaker ZR Ultra S 0.2 nozzle |  |
| ORCA_ERROR | WonderMaker/WonderMaker ZR Ultra S 0.4 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-twOzjy/command-LtWJaX") |
...
| DIVERGENT | iQ/iQ TiQ8 0.4 Nozzle | (no match across 6 oracle runs) first difference at byte 22135 (line 885, column 6; expected 130340 bytes, actual 130358 bytes) context:   line 884: "G1 Z1 F18000"   line 885: expected "G1 X246.061 Y187.924 Z1"; actual "G1 X237.93 Y195.977 Z1"   line 886: "G1 Z.6" |
