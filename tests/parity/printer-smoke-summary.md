...
892 of 1001 printers pass the strict ordered-byte comparison (generator identity/timestamp lines normalized; classic wall generator baseline; cube model).
...
| DIVERGENT | BBL/Bambu Lab X1 Carbon 0.8 nozzle | (no match across 6 oracle runs) first difference at byte 54900 (line 800, column 1; expected 111704 bytes, actual 112087 bytes) context:   line 799: "G1 X100 F5000"   line 800: expected "G1 X70 F15000"; actual "M73 P58 R4"   line 801: expected "M73 P58 R4"; actual "G1 X70 F15000" |
...
| ORCA_ERROR | Cubicon/Cubicon xCeler-I 0.4 nozzle | Export/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-aiIUlv/command-UWDVb4") |
| ORCA_ERROR | Cubicon/Cubicon xCeler-Mini 0.4 nozzle | Export/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-aiIUlv/command-HsV8yU") |
| ORCA_ERROR | Cubicon/Cubicon xCeler-Plus 0.4 nozzle | Export/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-aiIUlv/command-cMVpGj") |
...
| ORCA_ERROR | Custom/MyToolChanger 0.4 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-aiIUlv/command-aHSBJA") |
...
| DIVERGENT | Elegoo/Elegoo Neptune X 0.4 nozzle | (no match across 6 oracle runs) first difference at byte 1488 (line 76, column 1; expected 105063 bytes, actual 105872 bytes) context:   line 75: "G1 E5 F3600"   line 76: expected "M73 P4 R7"; actual ";TYPE:Inner wall"   line 77: expected ";TYPE:Inner wall"; actual ";WIDTH:0.5" |
...
| ORCA_ERROR | Flashforge/Flashforge Creator 5 0.8 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-aiIUlv/command-WHRn51") |
| PASS | Flashforge/Flashforge Creator 5 Pro 0.4 nozzle |  |
| ORCA_ERROR | Flashforge/Flashforge Creator 5 Pro 0.6 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-aiIUlv/command-bPqeK0") |
...
| DIVERGENT | LH/LH Stinger MMU 0.4 nozzle | (no match across 6 oracle runs) first difference at byte 627 (line 23, column 1; expected 134921 bytes, actual 135322 bytes) context:   line 22: ";TYPE:Custom"   line 23: expected "_SP_PRINT_START LANE=0 TEMP=230"; actual " _SP_PRINT_START LANE=0 TEMP=230"   line 24: "" |
...
| DIVERGENT | Prusa/Prusa CORE One L 0.4 nozzle | (no match across 6 oracle runs) first difference at byte 7475 (line 343, column 6; expected 95769 bytes, actual 96077 bytes) context:   line 342: ";WIDTH:0.45"   line 343: expected "G1 F1912"; actual "G1 F1899"   line 344: "G1 X145.675 Y154.325 E.29279" |
| DIVERGENT | Prusa/Prusa CORE One L 0.5 nozzle | (no match across 6 oracle runs) first difference at byte 514 (line 21, column 9; expected 90047 bytes, actual 90702 bytes) context:   line 20: "M486 S-1"   line 21: expected "M73 P0 R29"; actual "M73 P0 R30"   line 22: "M201 X10000 Y10000 Z400 E5000" |
...
| DIVERGENT | Prusa/Prusa CORE One L HF 0.4 nozzle | (no match across 6 oracle runs) first difference at byte 7439 (line 340, column 6; expected 95301 bytes, actual 95609 bytes) context:   line 339: ";WIDTH:0.45"   line 340: expected "G1 F1907"; actual "G1 F1899"   line 341: "G1 X145.675 Y154.325 E.29279" |
...
| DIVERGENT | Prusa/Prusa XL 0.4 nozzle | (no match across 6 oracle runs) first difference at byte 3163 (line 134, column 1; expected 92665 bytes, actual 93155 bytes) context:   line 133: "G1 Z.2"   line 134: expected "M73 P83 R6"; actual "G1 E.8 F1800"   line 135: expected "G1 E.8 F1800"; actual ";TYPE:Bottom surface" |
...
| ORCA_ERROR | Prusa/Prusa XL 5T 0.25 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-aiIUlv/command-TWCaSI") |
| ORCA_ERROR | Prusa/Prusa XL 5T 0.3 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-aiIUlv/command-yf0ZeD") |
| ORCA_ERROR | Prusa/Prusa XL 5T 0.4 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-aiIUlv/command-5kboFN") |
| PASS | Prusa/Prusa XL 5T 0.5 nozzle |  |
| PASS | Prusa/Prusa XL 5T 0.6 nozzle |  |
| ORCA_ERROR | Prusa/Prusa XL 5T 0.8 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-aiIUlv/command-MqrKQg") |
...
| DIVERGENT | Qidi/Qidi X-Max 3 0.2 nozzle | (no match across 6 oracle runs) first difference at byte 2481 (line 106, column 1; expected 299472 bytes, actual 299357 bytes) context:   line 105: "G1 X157.775 Y157.775 E.08799"   line 106: expected "G1 X167.225 Y157.775 E.08799"; actual "M73 P25 R14"   line 107: expected "M73 P25 R14"; actual "G1 X167.225 Y157.775 E.08799" |
| DIVERGENT | Qidi/Qidi X-Max 3 0.4 nozzle | (no match across 6 oracle runs) first difference at byte 2509 (line 114, column 1; expected 118483 bytes, actual 121138 bytes) context:   line 113: "G1 X166.3 Y161.936 E.02598"   line 114: expected "M73 P46 R5"; actual "G1 X163.064 Y158.7 E.17705"   line 115: expected "G1 X163.064 Y158.7 E.17705"; actual "G1 X162.393 Y158.7 E.02598" |
...
| DIVERGENT | Ratrig/RatRig V-Core 4 IDEX 500 COPY MODE 0.8 nozzle | (no match across 6 oracle runs) first difference at byte 3139 (line 129, column 7; expected 84551 bytes, actual 84822 bytes) context:   line 128: ";WIDTH:0.75"   line 129: expected "G1 F2216"; actual "G1 F2226"   line 130: "G1 X246.771 Y253.229 E.46736" |
...
| DIVERGENT | Snapmaker/Snapmaker A250 Dual (0.2 nozzle) | (no match across 6 oracle runs) first difference at byte 13826 (line 605, column 1; expected 193724 bytes, actual 194111 bytes) context:   line 604: "G1 X110.871 Y123.543 E.08297"   line 605: expected "M73 P11 R12"; actual "G1 X110.871 Y123.812 E.00282"   line 606: expected "G1 X110.871 Y123.812 E.00282"; actual "M73 P11 R12" |
...
| ORCA_ERROR | Snapmaker/Snapmaker U1 (0.2 nozzle) | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-aiIUlv/command-oUMLgp") |
| ORCA_ERROR | Snapmaker/Snapmaker U1 (0.4 nozzle) | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-aiIUlv/command-oWf1UP") |
| ORCA_ERROR | Snapmaker/Snapmaker U1 (0.4+0.6 nozzle) | Export/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-aiIUlv/command-V6VJxZ") |
| ORCA_ERROR | Snapmaker/Snapmaker U1 (0.6 nozzle) | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-aiIUlv/command-aM9VLu") |
| ORCA_ERROR | Snapmaker/Snapmaker U1 (0.8 nozzle) | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-aiIUlv/command-ZTGPsq") |
...
| ORCA_ERROR | WonderMaker/WonderMaker ZR Ultra 0.2 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-aiIUlv/command-b10Q18") |
| PASS | WonderMaker/WonderMaker ZR Ultra 0.4 nozzle |  |
| PASS | WonderMaker/WonderMaker ZR Ultra 0.6 nozzle |  |
| ORCA_ERROR | WonderMaker/WonderMaker ZR Ultra 0.8 nozzle | Slice/Process: unsuccessful Orca process; evidence Some("/tmp/ares-parity-artifacts/orca-runner-aiIUlv/command-oaowlJ") |
