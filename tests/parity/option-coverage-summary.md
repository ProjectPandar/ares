...
274 of 348 executable option domains pass (1054 generated cases).
...
| FAIL | auxiliary_fan | coBool | 2 | src/libslic3r/PrintConfig.cpp:3824 | true: preamble differs at line 22: expected Some("M106 S0"), actual Some("G90") |
...
| FAIL | bottom_solid_infill_flow_ratio | coFloat | 3 | src/libslic3r/PrintConfig.cpp:1377 | min: filament 1 length differs: expected 256.67mm, actual 262.34mm |
...
| FAIL | close_fan_the_first_x_layers | coInts | 3 | src/libslic3r/PrintConfig.cpp:1923 | max: postamble differs at line 103: expected Some("; printing object cube10.stl id:0 copy 0"), actual Some("G1 Z9.6 F9000") |
...
| FAIL | enable_support | coBool | 2 | src/libslic3r/PrintConfig.cpp:6054 | true: preamble differs at line 15: expected Some("; support material extrusion width = 0.38mm"), actual Some("; first layer extrusion width = 0.42mm") |
...
| FAIL | enforce_support_layers | coInt | 3 | src/libslic3r/PrintConfig.cpp:6164 | max: preamble differs at line 15: expected Some("; support material extrusion width = 0.38mm"), actual Some("; first layer extrusion width = 0.42mm") |
...
| FAIL | fan_max_speed | coFloats | 3 | src/libslic3r/PrintConfig.cpp:4711 | min: postamble differs at line 103: expected Some("; printing object cube10.stl id:0 copy 0"), actual Some("G1 Z9.6 F9000") |
| FAIL | fan_min_speed | coFloats | 3 | src/libslic3r/PrintConfig.cpp:4771 | min: layer 1 control events differs: expected [";BEFORE_LAYER_CHANGE", ";0.2", "G92 E0", "", ";_SET_FAN_SPEED_CHANGING_LAYER", "; printing object cube10.stl id:0 copy 0", "; stop printing object cube10.stl id:0 copy 0", "M106 S252"], actual [";BEFORE_LAYER_CHANGE", ";0.2", "G92 E0", "", ";_SET_FAN_SPEED_CHANGING_LAYER", "; printing object cube10.stl id:0 copy 0", "; stop printing object cube10.stl id:0 copy 0", "M106 S255"] |
...
| FAIL | filament_z_hop_types | coEnums | 4 | src/libslic3r/PrintConfig.cpp:67 | Auto Lift: layer 1 travel geometry differs: no match for Travel { motion: MotionRecord { command: "G1", start: Position { x: "104.152", y: "103.014", z: "0.2" }, end: Position { x: "109.255", y: "108.69", z: "0.6" }, arc_center: [None, None], turns: None }, feed: 9000.0, acceleration: "500" } |
...
| FAIL | gap_fill_target | coEnum | 3 | src/libslic3r/PrintConfig.cpp:1178 | everywhere: filament 1 length differs: expected 262.62mm, actual 262.34mm |
...
| FAIL | gcode_label_objects | coBool | 2 | src/libslic3r/PrintConfig.cpp:3951 | false: layer 50 control events differs: expected [";BEFORE_LAYER_CHANGE", ";10", "G92 E0", "", ";_SET_FAN_SPEED_CHANGING_LAYER", "M106 S0", "; filament end gcode ", "M140 S0", "M104 S0", "M107", "M84 X Y E", "; EXECUTABLE_BLOCK_END", "", "; filament used [cm3] = 0.63", "; filament used [g] = 0.78", "; filament cost = 0.02", "; total filament used [g] = 0.78", "; total filament cost = 0.02", "; total layers count = 50", "", "", ""], actual [";BEFORE_LAYER_CHANGE", ";10", "G92 E0", "", ";_SET_FAN_SPEED_CHANGING_LAYER", "M106 S0", "; filament end gcode ", "M140 S0", "M104 S0", "M107", "M84 X Y E", "; EXECUTABLE_BLOCK_END", "", "; filament used [cm3] = 0.63", "; filament used [g] = 0.78", "; filament cost = 0.02", "", "; total layers count = 50", "", ""] |
...
| FAIL | precise_outer_wall | coBool | 2 | src/libslic3r/PrintConfig.cpp:1484 | false: layer 2 deposition 58 differs: expected Deposition { feature: "Internal solid infill", width: "0.513045", motion: MotionRecord { command: "G1", start: Position { x: "113.929", y: "113.127", z: "0.4" }, end: Position { x: "113.155", y: "113.901", z: "0.4" }, arc_center: [None, None], turns: None }, extrusion: "0.04195", feed: 3000.0, acceleration: "500", fans: "0:255" }, actual Deposition { feature: "Internal solid infill", width: "0.513045", motion: MotionRecord { command: "G1", start: Position { x: "113.929", y: "113.127", z: "0.4" }, end: Position { x: "113.127", y: "113.929", z: "0.4" }, arc_center: [None, None], turns: None }, extrusion: "0.04348", feed: 3000.0, acceleration: "500", fans: "0:255" } |
...
| FAIL | top_solid_infill_flow_ratio | coFloat | 3 | src/libslic3r/PrintConfig.cpp:1366 | min: filament 1 length differs: expected 256.59mm, actual 262.34mm |
...
| FAIL | wall_sequence | coEnum | 3 | src/libslic3r/PrintConfig.cpp:2158 | inner-outer-inner wall: layer 2 deposition 58 differs: expected Deposition { feature: "Internal solid infill", width: "0.513045", motion: MotionRecord { command: "G1", start: Position { x: "113.929", y: "113.127", z: "0.4" }, end: Position { x: "113.155", y: "113.901", z: "0.4" }, arc_center: [None, None], turns: None }, extrusion: "0.04195", feed: 3000.0, acceleration: "500", fans: "0:255" }, actual Deposition { feature: "Internal solid infill", width: "0.513045", motion: MotionRecord { command: "G1", start: Position { x: "113.929", y: "113.127", z: "0.4" }, end: Position { x: "113.127", y: "113.929", z: "0.4" }, arc_center: [None, None], turns: None }, extrusion: "0.04348", feed: 3000.0, acceleration: "500", fans: "0:255" } |
...
| FAIL | wipe_on_loops | coBool | 2 | src/libslic3r/PrintConfig.cpp:5643 | true: layer 1 island lifecycle differs: expected [[Extruder { extrusion: "-4", feed: "3600" }], [Extruder { extrusion: "4", feed: "2400" }], [Extruder { extrusion: "4", feed: "2400" }, Extruder { extrusion: "-2.8", feed: "3600" }, WipeStart, Wipe { motion: MotionRecord { command: "G1", start: Position { x: "103.362", y: "103.627", z: "0.2" }, end: Position { x: "104.152", y: "103.014", z: "0.2" }, arc_center: [None, None], turns: None }, extrusion: "-1.2", feed: "3000" }, WipeEnd], [Extruder { extrusion: "4", feed: "2400" }, Extruder { extrusion: "-2.8", feed: "3600" }, WipeStart, Wipe { motion: MotionRecord { command: "G1", start: Position { x: "114.613", y: "114.669", z: "0.2" }, end: Position { x: "113.69", y: "114.654", z: "0.2" }, arc_center: [None, None], turns: None }, extrusion: "-1.2", feed: "1800" }, WipeEnd]], actual [[Extruder { extrusion: "-4", feed: "3600" }], [Extruder { extrusion: "4", feed: "2400" }], [Extruder { extrusion: "4", feed: "2400" }, Extruder { extrusion: "-2.8", feed: "3600" }, WipeStart, Wipe { motion: MotionRecord { command: "G1", start: Position { x: "103.362", y: "103.627", z: "0.2" }, end: Position { x: "104.152", y: "103.014", z: "0.2" }, arc_center: [None, None], turns: None }, extrusion: "-1.2", feed: "3000" }, WipeEnd], [Extruder { extrusion: "4", feed: "2400" }, Extruder { extrusion: "-2.8", feed: "3600" }, WipeStart, Wipe { motion: MotionRecord { command: "G1", start: Position { x: "114.69", y: "114.65", z: "0.2" }, end: Position { x: "113.69", y: "114.654", z: "0.2" }, arc_center: [None, None], turns: None }, extrusion: "-1.2", feed: "1800" }, WipeEnd]] |
...
| FAIL | z_hop_types | coEnums | 4 | src/libslic3r/PrintConfig.cpp:5282 | Auto Lift: layer 1 travel geometry differs: no match for Travel { motion: MotionRecord { command: "G1", start: Position { x: "104.152", y: "103.014", z: "0.2" }, end: Position { x: "109.255", y: "108.69", z: "0.6" }, arc_center: [None, None], turns: None }, feed: 9000.0, acceleration: "500" } |
